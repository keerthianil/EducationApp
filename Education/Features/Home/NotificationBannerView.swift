    ...
    var body: some View {
        HStack(spacing: Spacing.small) {
            ...
            VStack(alignment: .leading, spacing: 2) {
                Text(title).font(Typography.bodyBold).foregroundColor(ColorTokens.textPrimary)
                Text(subtitle).font(Typography.footnote).foregroundColor(ColorTokens.textSecondary)
            }
